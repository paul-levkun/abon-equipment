  ...
  <VLayout>
    <template #header>
      <div class="flex flex-row justify-between">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Реєстри</h2>
...
export default {
  ...
  computed: {
    dictList() {
      const dicts = this.$store.getters["dictModule/regs"];
      return dicts;
    },
  },
  ...
  mounted() {
    if (
      ...
      this.$store.commit("dictModule/setStructName", "Реєстр");
